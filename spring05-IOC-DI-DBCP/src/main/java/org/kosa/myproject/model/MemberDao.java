...
/**
 * final field 로 DataSource 를 선언 Constructor Injection 실제 DataSource를 이용해
 * spring_member table의 회원정보를 조회하여 회원객체를 리턴한다
 */
@Repository
public class MemberDao {
	...
	public MemberVo findMemberById(String id) throws SQLException {
		...
		try {
			...
			closeAll(rs, pstmt, con); // DBCP 로부터 빌린 커넥션을 반납한다
		}
		return memberVO;
	}
