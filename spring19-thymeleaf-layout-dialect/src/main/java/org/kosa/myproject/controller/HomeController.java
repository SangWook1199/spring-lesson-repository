...
public class HomeController {
	...
	public String studyResult2(int orderId, String maker) {
	...
	public String study5(Model model) {
		...
		return "step05-if-unless-switch"; // view name을 리턴
	}
	...
	public String study6(Model model) {
		...
		List<Map<String, String>> memberMapList = memberMapper.findMemberMapList();
		model.addAttribute("memberMapList", memberMapList);
